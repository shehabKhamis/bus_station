...
import static bus.Bus.passenger;
import bus.Passenger;

/**
 *
 * @author ABD-ELRAHMAN
 */
public class PassLogin extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
            ...
            String password = String.valueOf(jPasswordField1.getPassword());
                if(name.equals(passenger.get(0).getName()) && Integer.parseInt(password) == passenger.get(0).getPassword())
                    flag = 1;
            if(flag == 1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PassLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
