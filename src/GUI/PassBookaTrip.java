 ...
 * @author ABD-ELRAHMAN
 */
public class PassBookaTrip extends javax.swing.JFrame {

    /**
     * Creates new form PassLogin
     */
    public PassBookaTrip() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Search for a trip");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PassBookaTrip.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PassBookaTrip().setVisible(true);
            }
        });
    }
